...
async function loadChallengesPage() {
  try {
    ...
    console.error("Failed to load challenges page:", err);
...
document.addEventListener("visibilitychange", () => {
  if (document.visibilityState === "visible") loadChallengesPage();
});

window.addEventListener("DOMContentLoaded", loadChallengesPage);
